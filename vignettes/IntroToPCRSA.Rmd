...
interest by comparing the region of interest to the surrounding genome. To do this we will 
...
These plots show that Esr1 and Gata3 binding regions are variable compared to the surrounding genome while Nrf1 and Atf3 are not.  
