...
regionSetScores <- aggregateSignalGRList(signal=brcaLoadings1, 
                            signalCoord=brcaMCoord1, 
                            GRList=GRList, 
...
loadProfile <- lapply(wideGRList, function(x) getMetaRegionProfile(signal=brcaLoadings1,
                                                                signalCoord=brcaMCoord1,
                                                                regionSet=x, 
                                                                signalCol=PCsToAnnotate,
                                                                binNum=21))
...
```{r, eval=TRUE, message=FALSE, warning=FALSE}
regionQuantileByTargetVar(signal = brcaLoadings1,
                                signalCoord = brcaMCoord1,
                                regionSet = esr1_chr1,
