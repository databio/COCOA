...
2. Genomic coordinates associated with the PCA loadings and the raw data used for the PCA.
...
We have region sets for four transcription factors from the appropriate reference genome: Esr1, Gata3, Nrf1, and Atf1.
...
Now let's give each region set a score to quantify how much it is associated with each principal component:
